...
<main class="grid place-items-center  bg-white max-w-7xl mx-auto my-12">
  <section class="max-w-7xl mx-auto py-10 grid grid-cols-2 gap-8 py-10 px-5  bg-gray-100 rounded-md shadow-lg w-3/4 md:max-w-2xl">
    ...
    <div class="text-indigo-500">   
      ...
      <h3 class="text-2xl font-semibold mb-7">${data.price} USD</h3>

      <div>
      <input type="number" id="inputValue" class="border border-gray-500" />
  </div>
      <div class="flex gap-0.5 mt-4">
        <button id="btnAddToCart" class="bg-indigo-600 hover:bg-indigo-500 focus:outline-none transition text-white uppercase px-8 py-3">add to cart</button>
        <button id="btnAddToCart" class="bg-indigo-600 hover:bg-indigo-500 focus:outline-none transition text-white uppercase p-3">
