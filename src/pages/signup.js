          ...
          <div class="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
            <form    id="formSignUp">
              ...
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                ...
                <input id="username" class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-600 rounded-r-full focus:outline-none" type="text" placeholder="User name">
              </div>
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span class="inline-block pr-3 py-2 border-r border-gray-50">
                <svg class="w-5 h-5" width="20" height="21" viewbox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input id="email" class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-600 rounded-r-full focus:outline-none" type="email" placeholder="Email">
              </div>
              <div class="flex items-center pl-6 mb-6 bg-white rounded-full">
                ...
                <input id="password" class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-600 rounded-r-full focus:outline-none" type="password" placeholder="Password">
              </div>
