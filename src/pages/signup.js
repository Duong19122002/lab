...
const Signup = {
    ...
    //     `;
    return /*html*/`
    <section class="relative py-20 2xl:py-40 bg-white-800 overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
          <div class="max-w-md">
            <span class="text-lg text-blue-400 font-bold">ĐĂNG KÝ TÀI KHOẢN</span>
            <h2 class="mt-8 mb-12 text-blue-400 text-5xl font-bold font-heading text-white">Chào mừng bạn đã đến với chúng tôi, xin vui lòng điền vào mẫu trống !</h2>
        ...
        <div class="w-full lg:w-1/2 px-4">
          <div class="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
            <form action="#" id="formSignUp">
              <h3 class="mb-10 text-2xl text-white font-bold font-heading">ĐĂNG KÝ</h3>
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                ...
                <input id="username" class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="text" placeholder="User name">
              </div>
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span class="inline-block pr-3 py-2 border-r border-gray-50">
                <svg class="w-5 h-5" width="20" height="21" viewbox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input id="email" class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="Email">
              </div>
              <div class="flex items-center pl-6 mb-6 bg-white rounded-full">
                <span class="inline-block pr-3 py-2 border-r border-gray-50">
                <svg class="w-5 h-5" width="17" height="21" viewbox="0 0 17 21" fill="none" xmlns="">
                ...
                <input id="password" class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="password" placeholder="Password">
              </div>
              ...
              <button class="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Get started</button>
            </form>
          </div>
        </div>
      </div>
