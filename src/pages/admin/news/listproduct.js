                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ${data.map((post, index) => `
                                                        <tr>
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap> 
                                                            <a href="/#/news/${post.id}"> <img class="h-16 w-16" src="${post.img}" class="rounded h-96 w-96" alt="technology" /></a>
                                                            </td>
                                                            <td class="px-6 py-4 whitespace-nowrap">
                                                            ${post.price}
                                                        </td>
                                                            <td class="px-6 py-4 whitespace-nowrap">
                                                            <a class="btn btn-remove inline-block px-4 py-3 text-white rounded bg-indigo-500 hover:bg-indigo-800" href="/#/admin/products/${post.id}/edit">Edit</a>   
